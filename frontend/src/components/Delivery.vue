    ...
    <v-card style="width:450px;" outlined>
        ...
        <v-card-actions>
            ...
            <v-btn
                    ...
                    color="deep-purple lighten-2"
                    text
                    @click="openConfirmDelivered"
            >
                ConfirmDelivered
            </v-btn>
            <v-dialog v-model="confirmDeliveredDiagram" width="500">
                <ConfirmDeliveredCommand
                        @closeDialog="closeConfirmDelivered"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            async confirmDelivered(params) {
                try {
                    if(!this.offline) {
                        var temp = await axios.put(axios.fixUrl(this.value._links['confirmdelivered'].href), params)
                        for(var k in temp.data) {
                            this.value[k]=temp.data[k];
                        }
                    }
            ...
            openConfirmDelivered() {
                this.confirmDeliveredDiagram = true;
            },
            closeConfirmDelivered() {
                this.confirmDeliveredDiagram = false;
            },
        },
    }
</script>
