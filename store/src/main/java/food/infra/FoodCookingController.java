...
public class FoodCookingController {
    ...
    @RequestMapping(value = "foodCookings/{id}/reject",
        method = RequestMethod.PUT,
        produces = "application/json;charset=UTF-8")
    public FoodCooking reject(@PathVariable(value = "id") Long id, @RequestBody RejectCommand rejectCommand, HttpServletRequest request, HttpServletResponse response) throws Exception {
            System.out.println("##### /foodCooking/reject  called #####");
            Optional<FoodCooking> optionalFoodCooking = foodCookingRepository.findById(id);
            
            optionalFoodCooking.orElseThrow(()-> new Exception("No Entity Found"));
            FoodCooking foodCooking = optionalFoodCooking.get();
            foodCooking.reject(rejectCommand);
    ...
    @RequestMapping(value = "foodCookings/{id}/start",
        method = RequestMethod.PUT,
        produces = "application/json;charset=UTF-8")
    public FoodCooking start(@PathVariable(value = "id") Long id, @RequestBody StartCommand startCommand, HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    @RequestMapping(value = "foodCookings/{id}/finish",
        method = RequestMethod.PUT,
        produces = "application/json;charset=UTF-8")
    public FoodCooking finish(@PathVariable(value = "id") Long id, @RequestBody FinishCommand finishCommand, HttpServletRequest request, HttpServletResponse response) throws Exception {
